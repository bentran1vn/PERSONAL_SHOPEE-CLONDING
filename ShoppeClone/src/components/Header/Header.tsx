      ...
      <div className='container'>
            ...
            renderPopover={
              <div className='bg-white relative shadow-md rounded-sm border border-gray-200'>
                <div className='flex flex-col py-2 pr-32 pl-3'>
                  <div className='button py-2 px-3 hover:text-orange'>Tiếng Việt</div>
                  <div className='button py-2 px-3 hover:text-orange mt-2'>English</div>
                </div>
              </div>
            }
          >
        ...
        <div className='mt-5 grid grid-cols-12 gap-4'>
          <Link to='/' className='col-span-2'>
            <svg viewBox='0 0 192 65' className='h-11 fill-white w-full'>
              <g fillRule='evenodd'>
                    ...
                    <div className='mt-5'>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
                          <img
                            src='https://down-vn.img.susercontent.com/file/sg-11134201-7rcet-lsjh2sf35z9xa3_tn'
                            alt='productImage'
                        ...
                        <div className='flex-grow ml-2 overflow-hidden'>
                          <div className='truncate'>
                            Kyushuad Quần nam Mỹ retro đường phố cao cấp thích hợp hạng nặng đau khổ giặt thiết kế quần
                            jean ống rộng loe
                          </div>
                        </div>
                        <div className='ml-2 flex-shrink-0'>
                          <span className='text-orange'>đ456.789</span>
                        </div>
                      </div>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
