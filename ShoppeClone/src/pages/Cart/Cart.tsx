...
export default function Cart() {
  ...
  const totalCheckPurchaseSavingPrice = useMemo(
    () =>
      checkedPurchases.reduce((result, current) => {
        ...
        {extendedPurchase.length > 0 ? (
          ...
          <div className='text-center'>
            <img
              ...
              alt='No Purchase'
            />
            <div className='font-bold mt-5 text-gray-500'>Giỏ hàng của bạn còn trống</div>
            <div className='mt-5'>
              <Link
                to={path.home}
                className=' bg-orange px-10 rounded-sm hover:bg-orange/80 transition-all py-3 uppercase text-white'
              >
                Mua Ngay
              </Link>
            </div>
